    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-teamProjets">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.projet.fields.type') }}
                            </th>
                            <th>
...
@endcan
  ...
  let table = $('.datatable-teamProjets:not(.ajaxTable)').DataTable({ buttons: dtButtons })
