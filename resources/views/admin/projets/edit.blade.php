...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.projet.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.projets.update", [$projet->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nom') ? 'is-invalid' : '' }}" type="text" name="nom" id="nom" value="{{ old('nom', $projet->nom) }}" required>
                @if($errors->has('nom'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $projet->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_debut') ? 'is-invalid' : '' }}" type="text" name="date_debut" id="date_debut" value="{{ old('date_debut', $projet->date_debut) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_fin') ? 'is-invalid' : '' }}" type="text" name="date_fin" id="date_fin" value="{{ old('date_fin', $projet->date_fin) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('teams') ? 'is-invalid' : '' }}" name="teams[]" id="teams" multiple>
                    @foreach($teams as $id => $team)
                        <option value="{{ $id }}" {{ (in_array($id, old('teams', [])) || $projet->teams->contains($id)) ? 'selected' : '' }}>{{ $team }}</option>
                    @endforeach
                </select>
                @if($errors->has('teams'))
