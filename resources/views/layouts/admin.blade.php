...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('../assets2/vendor/themify-icons/themify-icons.css') }}">
    <link rel="stylesheet" href="{{ asset('../assets/vendor/fontawesome/css/font-awesome.min.css') }}">   
    <link rel="stylesheet" href="{{ asset('../assets2/vendor/nestable/jquery-nestable.css') }}"/>
    <link rel="stylesheet" href="{{ asset('../assets2/css/main.css') }}" type="text/css">
...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
            ...
            <ul class="navbar-nav ml-auto">
              <li class="nav-item dropdown">
                <a class="nav-link nav-link-icon" href="{{url('profile/password')}}" id="navbar_1_dropdown_3" role="button"
                  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user"></i></a>
                <div class="dropdown-menu dropdown-menu-right">
                  <h6 class="dropdown-header">Menu de l'utilisateur</h6>
                  <a class="dropdown-item" href="{{url('profile/password')}}"><i class="fa fa-user text-primary"></i> Mon Profile</a>                                  
                </div>
              </li>
