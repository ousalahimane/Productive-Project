...
class User extends Authenticatable
{
    ...
    public function participantsReunions()
    {
    ...
    {
        if ($input) {
            $this->attributes['password'] = app('hash')->needsRehash($input) ? \Illuminate\Support\Facades\Hash::make($input) : $input;
        }
    }
